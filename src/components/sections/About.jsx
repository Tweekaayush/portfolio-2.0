      ...
      <div className="flex flex-col items-center gap-4 md:flex-row w-full mb-10">
        ...
        <div className="md:basis-3/5 md:order-1">
          ...
          <p>
            ...
            applications. With a toolbox filled with MongoDB, ExpressJs, React,
            NodeJs and Redux, I thrive on turning design concepts into seamless
            and interactive web experiences.
          </p>
        </div>
      </div>
      <div className="flex flex-col">
        <p className="mb-10">Here's some of the technologies that I've been working with:</p>
        <ul className="flex items-center flex-wrap gap-10 w-full">
          <li className="w-7 h-7 sm:w-9 sm:h-9">
            <img src='/Tech/mongodb.png' alt="mongodb" className="w-full h-full"/>
          </li>
          <li className="w-7 h-7 sm:w-9 sm:h-9">
            <img src='/Tech/express.png' alt="express" className="w-full h-full"/>
          </li>
          <li className="w-7 h-7 sm:w-9 sm:h-9">
            <img src='/Tech/React.png' alt="react" className="w-full h-full"/>
          </li>
          <li className="w-7 h-7 sm:w-9 sm:h-9">
            <img src='/Tech/node.png' alt="node" className="w-full h-full"/>
          </li>
          <li className="w-7 h-7 sm:w-9 sm:h-9">
            <img src='/Tech/redux.png' alt="redux" className="w-full h-full"/>
          </li>
          <li className="w-7 h-7 sm:w-9 sm:h-9">
            <img src='/Tech/tailwind.png' alt="tailwind" className="w-full h-full"/>
          </li>
          <li className="w-7 h-7 sm:w-9 sm:h-9">
            <img src='/Tech/HTML5.png' alt="HTML5" className="w-full h-full"/>
          </li>
          <li className="w-7 h-7 sm:w-9 sm:h-9">
            <img src='/Tech/CSS3.png' alt="CSS3" className="w-full h-full"/>
          </li>
          <li className="w-7 h-7 sm:w-9 sm:h-9">
            <img src='/Tech/JavaScript.png' alt="JavaScript" className="w-full h-full"/>
          </li>
        </ul>
      </div>
    </motion.section>
